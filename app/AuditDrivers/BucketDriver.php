...
class BucketDriver implements AuditDriver
{
    /**
    ...
    {
        $this->disk = Storage::disk(Config::get('audit.drivers.filesystem.disk', 'do'));
        $this->dir = Config::get('audit.drivers.filesystem.dir', 'audits');
